# nvim-treesitter-queries-erlang

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-erlang/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-erlang/actions/workflows/validate.yml)

Neovim tree-sitter queries for **erlang**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-erlang",
...
- [ ] Changes are scoped to `erlang` — do not include files for other languages
